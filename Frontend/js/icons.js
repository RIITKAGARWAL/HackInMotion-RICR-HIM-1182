// ============================================================
// SpenSight Icon Library
// Crisp, modern stroke icons in the Lucide style, rendered as
// inline SVG. Fully offline — no external icon CDN required.
// ============================================================
...
const SpenIcons = (() => {
  const PATHS = {
    ...
    'ArrowLeftRight': '<polyline points="8 3 4 7 8 11"/><polyline points="16 3 20 7 16 11"/><line x1="4" y1="7" x2="20" y2="7"/><polyline points="8 13 4 17 8 21"/><polyline points="16 13 20 17 16 21"/><line x1="4" y1="17" x2="20" y2="17"/>',
    'AlertTriangle': '<path d="M10.29 3.86 1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0z"/><line x1="12" y1="9" x2="12" y2="13"/><line x1="12" y1="17" x2="12.01" y2="17"/>',
    'Bell': '<path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9"/><path d="M13.73 21a2 2 0 0 1-3.46 0"/>',
    'Upload': '<path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="17 8 12 3 7 8"/><line x1="12" y1="3" x2="12" y2="15"/>',
    'Download': '<path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" y1="15" x2="12" y2="3"/>',
    'CloudDownload': '<path d="M20 16.58A5 5 0 0 0 18 7h-1.26A8 8 0 1 0 4 15.25"/><rect x="8" y="14" width="8" height="6" rx="1"/><path d="M12 10v6"/><path d="m9.5 13.5 2.5 2.5 2.5-2.5"/>',
    ...
    'Dumbbell': '<path d="M14.4 14.4 9.6 9.6"/><path d="M18.657 21.485a2 2 0 1 1-2.829-2.828l-1.767 1.768a2 2 0 1 1-2.829-2.829l6.364-6.364a2 2 0 1 1 2.829 2.829l1.767-1.768a2 2 0 1 1 2.829 2.828z"/><path d="m21.5 21.5-1.4-1.4"/><path d="M3.9 3.9 2.5 2.5"/><path d="M6.404 12.768a2 2 0 1 1-2.829-2.829l1.768-1.767a2 2 0 1 1-2.828-2.829l2.828-2.828a2 2 0 1 1 2.829 2.828l1.767-1.768a2 2 0 1 1 2.829 2.829z"/>',
    ...
    'Laptop': '<path d="M20 16V7a2 2 0 0 0-2-2H6a2 2 0 0 0-2 2v9m16 0H4a2 2 0 0 0-2 2v1a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-1a2 2 0 0 0-2-2z"/><path d="M6 10h4v3H6z"/>',
    ...
    'Dices': '<rect x="3" y="3" width="7" height="7" rx="1"/><rect x="14" y="3" width="7" height="7" rx="1"/><rect x="3" y="14" width="7" height="7" rx="1"/><rect x="14" y="14" width="7" height="7" rx="1"/><circle cx="6.5" cy="6.5" r=".5" fill="currentColor"/><circle cx="17.5" cy="6.5" r=".5" fill="currentColor"/><circle cx="6.5" cy="17.5" r=".5" fill="currentColor"/><circle cx="17.5" cy="17.5" r=".5" fill="currentColor"/>',
    ...
    'ClipboardList': '<rect x="8" y="2" width="8" height="4" rx="1"/><path d="M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2"/><path d="M12 11h4"/><path d="M12 16h4"/><path d="M8 11h.01"/><path d="M8 16h.01"/>',
  ...
  function icon(name, className) {
    ...
    const inner = PATHS[key] || PATHS['HelpCircle'];
    return `<svg ${SVG_ATTRS} class="icon ${className || ''}">${inner}</svg>`;
  }
  ...
  return { icon, has, PATHS };
})();

// Global helper so inline HTML can use SpenIcons.icon()
if (typeof window !== 'undefined') {
  window.SpenIcons = SpenIcons;
}
