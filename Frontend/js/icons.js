...
const SpenIcons = (() => {
  const PATHS = {
    ...
    ArrowLeftRight:
      '<polyline points="8 3 4 7 8 11"/><polyline points="16 3 20 7 16 11"/><line x1="4" y1="7" x2="20" y2="7"/><polyline points="8 13 4 17 8 21"/><polyline points="16 13 20 17 16 21"/><line x1="4" y1="17" x2="20" y2="17"/>',
    AlertTriangle:
    ...
    CloudDownload:
      '<path d="M20 16.58A5 5 0 0 0 18 7h-1.26A8 8 0 1 0 4 15.25"/><rect x="8" y="14" width="8" height="6" rx="1"/><path d="M12 10v6"/><path d="m9.5 13.5 2.5 2.5 2.5-2.5"/>',
    ...
    Dumbbell:
      '<path d="M14.4 14.4 9.6 9.6"/><path d="M18.657 21.485a2 2 0 1 1-2.829-2.828l-1.767 1.768a2 2 0 1 1-2.829-2.829l6.364-6.364a2 2 0 1 1 2.829 2.829l1.767-1.768a2 2 0 1 1 2.829 2.828z"/><path d="m21.5 21.5-1.4-1.4"/><path d="M3.9 3.9 2.5 2.5"/><path d="M6.404 12.768a2 2 0 1 1-2.829-2.829l1.768-1.767a2 2 0 1 1-2.828-2.829l2.828-2.828a2 2 0 1 1 2.829 2.828l1.767-1.768a2 2 0 1 1 2.829 2.829z"/>',
    Receipt:
    ...
    Laptop:
      '<path d="M20 16V7a2 2 0 0 0-2-2H6a2 2 0 0 0-2 2v9m16 0H4a2 2 0 0 0-2 2v1a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-1a2 2 0 0 0-2-2z"/><path d="M6 10h4v3H6z"/>',
    Building2:
    ...
    Dices:
      '<rect x="3" y="3" width="7" height="7" rx="1"/><rect x="14" y="3" width="7" height="7" rx="1"/><rect x="3" y="14" width="7" height="7" rx="1"/><rect x="14" y="14" width="7" height="7" rx="1"/><circle cx="6.5" cy="6.5" r=".5" fill="currentColor"/><circle cx="17.5" cy="6.5" r=".5" fill="currentColor"/><circle cx="6.5" cy="17.5" r=".5" fill="currentColor"/><circle cx="17.5" cy="17.5" r=".5" fill="currentColor"/>',
